...
filepath = os.path.abspath('datasets_full/London/london_sports_participation.csv')
...
for region in regions:
    ...
    zeroes = np.array(region_df[region_df['sports_participation'] == 'zero']['percentage'].tolist())
    ones = np.array(region_df[region_df['sports_participation'] == 'one+']['percentage'].tolist())
    threes = np.array(region_df[region_df['sports_participation'] == 'three+']['percentage'].tolist())
    ones = ones - threes
